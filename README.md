...
- **packages/react** — 25 React 19 components (Button, IconButton, Card, Panel, Toolbar, NavBar, AspectRatio, Input, Select, Field, Dialog, Checkbox, Switch, Tag, Tooltip, Menu, MenuItem, MenuSeparator, Table, TableHead, TableBody, TableRow, TableHeaderCell, TableCell, Pagination) + 22 icons
